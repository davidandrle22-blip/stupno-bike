...
type Circuit = {
  ...
  color: string;
  gpx: string;
  profile: string; // SVG polyline points string
};
...
const CIRCUITS: Circuit[] = [
  ...
  },
  {
    ...
    profile:
      "0,52 50,38 100,30 150,36 200,24 250,34 300,52",
  },
  {
    id: "zluta",
    name: "Žlutá trasa",
    ...
    <div>
      ...
      <div className="mb-10">
        ...
        <p className="text-gray-500 max-w-2xl leading-relaxed">
          ...
          kategorii Elite & U23 až po technickou enduro sekci. Stáhněte si GPX soubory pro import
          do cyklonavigace nebo si trasu prohlédněte na mapě.
        </p>
      </div>
            ...
            <div className="p-5">
              ...
              <div className="flex gap-2">
                ...
                <a
                  ...
                  className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-xl bg-slate-700 hover:bg-slate-600 text-white text-xs font-bold uppercase tracking-wide transition-colors"
                >
                  <svg
                    width="12"
                    height="12"
      ...
      {/* Embed Mapy.cz — přehled areálu */}
      <div className="rounded-2xl overflow-hidden border border-gray-border shadow-lg">
        <div className="bg-slate-800 px-5 py-3.5 flex items-center gap-2.5">
          <svg
            width="16"
            height="16"
            viewBox="0 0 16 16"
          ...
          <span className="text-white text-sm font-semibold uppercase tracking-wide">
            Areál Stupno — přehled tras
          </span>
          <a
            href="https://mapy.cz/turisticka?x=13.583&y=49.832&z=15"
            target="_blank"
            rel="noopener noreferrer"
            className="ml-auto text-teal-400 hover:text-teal-300 text-xs uppercase tracking-wide font-medium transition-colors"
          >
            Otevřít na celé obrazovce →
          </a>
        </div>
        <iframe
          src="https://mapy.cz/turisticka?x=13.583&y=49.832&z=15&l=0"
          className="w-full"
          style={{ height: "450px", border: "none" }}
          title="Mapa areálu Stupno Bike — závodní okruhy"
          allowFullScreen
        />
      </div>
