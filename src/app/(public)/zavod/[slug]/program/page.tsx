...
const STATIC_PROGRAM: ProgramDay[] = [
  {
    ...
    items: [
      ...
      { time: "16:00", desc: "MČR štafety DOSPĚLÍ" },
  ...
  },
  {
    ...
    items: [
      ...
      { time: "09:00", desc: "Kluci 5–6 let" },
      { time: "09:10", desc: "Holky 5–6 let" },
      { time: "09:20", desc: "Holky 7–8 let" },
      { time: "09:40", desc: "Kluci 7–8 let" },
      { time: "10:00", desc: "Holky 9–10 let" },
      { time: "10:30", desc: "Kluci 9–10 let" },
      { time: "11:00", desc: "Vyhlášení dopoledních dětských kategorií ČP XCO" },
      { time: "11:40", desc: "Žákyně II" },
      { time: "12:35", desc: "Žáci II" },
      { time: "13:30", desc: "Žákyně I" },
      { time: "14:15", desc: "Žáci I" },
      { time: "15:15", desc: "Kadeti, Masters, Experti" },
      { time: "16:30", desc: "Vyhlášení odpoledních kategorií" },
      { time: "16:30", desc: "Oficiální trénink na trati XCO (do 17:45, trať otevřena po dojetí Masters)" },
      { time: "18:00", desc: "BEER RIDE — pivní jízda v kostýmech (registrace ZDARMA)", entertainment: true },
      { time: "19:00", desc: "DISCO party MČR v areálu — DJ Jirka Forman", entertainment: true },
      { time: "22:30", desc: "Kapela Pops (do 00:00)", entertainment: true },
    ],
  },
  {
    ...
    items: [
      ...
      { time: "11:30", desc: "Ženy Elite / U23, Juniorky, Kadetky" },
